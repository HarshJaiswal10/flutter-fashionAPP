...
import 'package:eshop_by_harsh/pages/product_details.dart';
...
class Single_prod extends StatelessWidget {
  ...
  const Single_prod({Key key, this.prod_name, this.prod_picture, this.prod_old_price, this.prod_price}) : super(key: key);
